...
class RNN(tf.keras.Model): 
    def __init__(self, alphabet_size, embedding_size=128, window_size=100):
        ...
        self.decoder = tf.keras.layers.LSTM(128, return_sequences=True, return_state=True)
    ...
    def call(self, ciphertext, plaintext):
        ...
        decoded, _, _ = self.decoder(plaintext_embs, initial_state=(cell_state, hidden_state))
