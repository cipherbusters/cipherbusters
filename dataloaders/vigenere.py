...
class VigenereDataset(Dataloader):
    ...
    def get_train_epoch(self):
        return get_vigenere_batches(self.train_plain, self.batch_size, self.train_batches)

    def get_train_len(self):
        return self.train_batches

    def get_test_epoch(self):
        return get_vigenere_batches(self.test_plain, self.batch_size, self.test_batches)
